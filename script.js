...
var DEFAULT_DATA = {
  pilotos: [
    { id:1, nome:'Luiz Henrique', nickname:'César', emoji:'🦁', nacionalidade:'🇧🇷 Brasil', status:'Ativo', especialidade:'GT3 / Endurance', simulador:'Automobilista 1, NR2003', estiloPilotagem:'Agressivo e consistente', equipamentos:{volante:'Machenike G5PRO',pedais:'Gatilhos',assento:''}, bio:'Diretor Técnico', conquistas:[{icon:'🏆',text:'Campeão StockCar HRL 2025'}, ] stats:{corridas:0,vitorias:0,podios:0,pontos:0} },
